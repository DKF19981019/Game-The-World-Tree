 ...
 * @author  __USER__
 */
public class Baoju1 extends javax.swing.JFrame {

	/** Creates new form Baoju1 */
	public Baoju1() {

		initComponents();
		ModelFactory.playBackmusic(5);
	...
	private void initComponents() {
		...
		imageJpanel1.setImage(new ImageIcon("./src/img/´óµÛ±¦¾ß.gif").getImage());
